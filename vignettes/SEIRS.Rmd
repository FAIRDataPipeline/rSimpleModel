...
add_write(path = config_file,
          ...
          file_type = "csv")
add_write(path = config_file,
          data_product = "disease/sars_cov2/SEIRS_model/results/figure1",
          description = "SEIRS output plot 1",
          file_type = "pdf")
add_write(path = config_file,
          data_product = "disease/sars_cov2/SEIRS_model/results/figure2",
          description = "SEIRS output plot 2",
          file_type = "pdf")
...
g1 <- plot_SEIRS1(results)
g2 <- plot_SEIRS2(results)
...
path <- link_write(handle, "disease/sars_cov2/SEIRS_model/results/figure1") 
ggsave(path, g)

path <- link_write(handle, "disease/sars_cov2/SEIRS_model/results/figure2") 
ggsave(path, g)
