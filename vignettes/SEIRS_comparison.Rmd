...
ls ../pyDataPipeline
fair init --ci
fair pull ../pyDataPipeline/src/org/fairdatapipeline/simpleModel/ext/SEIRSconfig.yaml
fair run ../pyDataPipeline/src/org/fairdatapipeline/simpleModel/ext/SEIRSconfig.yaml
```
