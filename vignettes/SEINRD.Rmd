...
system2("/Users/Soniam/.poetry/bin/poetry", "install", stdout = TRUE)
```
...
cat(paste("#!/bin/sh\n",
          "cd /Users/Soniam/Desktop/git/FAIRDataPipeline/rSimpleModel/\n",
          "fair init --ci\n",
          "fair pull inst/extdata/SEINRD_model.yaml\n",
          "fair run inst/extdata/SEINRD_model.yaml"), file = tmp)
...
cat(readLines(file.path(here(), 'inst/extdata/SEINRD_model.yaml')), sep = '\n')
```
...
*SEINRD.R*:
```{r, code = readLines(file.path(here(), "inst/extdata/SEINRD.R")), eval=FALSE}
```
